...
char * make_request(char *url){
    ...
    if (curl)
    {
        ...
        else
        {
            ...
            FILE *fin = fopen("qwerty_26.json", "w");
            fprintf(fin,"%s\n", chunk.response);
            fclose(fin);
        }
...
int info(char *token) {
char *url1 = "http://edi.iem.pw.edu.pl:30000/worlds/api/v1/worlds/info/qwerty_26";

    make_request(url1);
}

int move(char *token) {
char *url1 = "http://edi.iem.pw.edu.pl:30000/worlds/api/v1/worlds/move/qwerty_26";

    make_request(url1);
}

int explore(char *token) {
char *url1 = "http://edi.iem.pw.edu.pl:30000/worlds/api/v1/worlds/explore/qwerty_26";

    make_request(url1);
}

int right(char *token) {
char *url1 = "http://edi.iem.pw.edu.pl:30000/worlds/api/v1/worlds/rotate/qwerty_26/right";

    make_request(url1);
}

int left(char *token) {
char *url1 = "http://edi.iem.pw.edu.pl:30000/worlds/api/v1/worlds/rotate/qwerty_26/left";
